<template>
  <nav class="navbar navbar-expand-lg navbar-dark template-color px-3">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      ...
      <form @submit.prevent="findPosts" class="bg-white rounded elevation-1">
        <div class="form-group d-flex align-items-center">
          ...
          <button class="btn px-2 py-0" type="submit">
            <i class="mdi mdi-card-search-outline f-18"></i>
          </button>
        </div>
      </form>
      <!-- TODO end of form -->
...
export default {
  setup() {
    ...
    return {
      ...
      async findPosts() {
        try {
          logger.log('this is the start of findPost function')
